...
function generateGallery() {
    ...
    // Improved WhatsApp sanitization from your new file
    ...
    setTimeout(() => {
        try {
            // Strip variant suffixes like (Medium), (Phone), etc. from the filename
            ...
            // Build image tags using the new structure
            ...
            // The finalized HTML generation template
...
<div class="zoom-overlay" id="zoomOverlay" onclick="closeZoom()">
    <img id="zoomedImage" src="">
            ...
            // Core Logic for Tokens and Tracking
